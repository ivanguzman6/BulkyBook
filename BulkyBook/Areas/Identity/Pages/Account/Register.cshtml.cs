    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            Input = new InputModel()
            {
                ...
                RoleList = _roleManager.Roles.Where(r => r.Name != SD.Role_User_Indi).Select(r => r.Name).Select(i => new SelectListItem
                {
                    Text = i,
                    Value = i
                })
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    //Esto es temporal, mientras estamos en desarrollo. Para produccion debe cambiar
